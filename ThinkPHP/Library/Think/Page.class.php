...
class Page{
    ...
    private function _styleSbadmin2()
    {
        $this->config = array(
            ...
            'theme'  => '<div class="col-sm-4"><div class="dataTables_info pagination" id="dataTables-example_info" role="status" aria-live="polite">第%NOW_PAGE%页/共%TOTAL_PAGE%页 %HEADER%</div></div><div class="col-sm-6 text-right"><div class="dataTables_paginate paging_simple_numbers" id="dataTables-example_paginate"><ul class="pagination">%UP_PAGE%%LINK_PAGE%%DOWN_PAGE%</ul></div></div>',
        );
